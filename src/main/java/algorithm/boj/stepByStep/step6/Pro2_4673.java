package main.java.algorithm.boj.stepByStep.step6;

import java.util.Vector;

public class Pro2_4673 {
    ...
    static int d(int n){
        ...
        if(n>0 && n<10){
            ...
            result = n + n/1000 + n/100 - n/1000*100*2 + n/10 - n/100*10 + n%10;
        }else{
            result = 10001;
        }
    ...
    static void selfNumber(int inputNumber){
        ...
        //삭제 타겟 찾아 모으기
        for (int i = 0; i < inputNumber; i++) {
            int popTarget = d((int)number.get(i));
